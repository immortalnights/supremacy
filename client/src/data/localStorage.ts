...
export const useLocalStorageValue = (key: string, deserialize = false): string | object | null => {
...
export const useLocalStorage = (key: string, defaultValue?: any, deserialize = false): [string | object | null, (value: any) => void ] => {
