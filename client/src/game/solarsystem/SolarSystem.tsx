        ...
        >
            {planets.map((planet) => (
                <ListItemButton
                    ...
                    onDoubleClick={() => handlePlanetClick(planet.id, true)}
                >
                    <ListItemAvatar />
...
const SelectedPlanetInfo = () => {
    ...
    const atmos = Recoil.useRecoilValue(PlayerShips).find(
        (s) => s.type === "Atmosphere Processor"
    )
    ...
    const handleConfirmEspionageDialog = (
        planet: IPlanetBasic,
        mission: string
    ) => {
        ...
        <div>
            {espionage && planet && (
                <EspionageDialog
                    open
                    planet={planet}
                    onConfirm={handleConfirmEspionageDialog}
                    onCancel={handleCancelEspionageDialog}
                />
            )}
            <Stack direction="column" alignItems="center">
                ...
                <div>
                    <Button
                        ...
                        onClick={handleClickTerraform}
                    >
                        Terraform
                    </Button>
                    <Button disabled={!canSpy} onClick={handleClickEspionage}>
                        Espionage
                    </Button>
                </div>
            </Stack>
    ...
    return report ? (
        <Stack direction="column" alignItems="center">
            ...
            <Grid container>
                ...
                <Grid item xs={2} />
                <Grid item xs={5}>
                    <StarDate date={report.date} />
                </Grid>
                {report.food !== undefined && (
                    <>
                        <Grid item xs={5} textAlign="right">
                            Food
                        </Grid>
            ...
            <div style={{ marginTop: "1rem" }}>
                <Button
                    ...
                    color="info"
                    size="small"
                    onClick={handleClickDismissReport}
                >
                    Dismiss Report
                </Button>
            </div>
