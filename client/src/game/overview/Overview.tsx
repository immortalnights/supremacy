    ...
    return (
        <div className="flex flex-rows" style={{ margin: "0 5px 0 0" }}>
            <IncDecButton
                label="Inc"
                mode="increase"
                onChange={(event, value) => handleChangeTax(value)}
                multiplier={5}
            />
            <IncDecButton
                label="Dec"
...
const PlanetDetails = ({ planet }: { planet: IPlanet }) => {
    const militaryStrength = Recoil.useRecoilValue(
    ...
    return (
        <div className="flex-columns" style={{ alignItems: "baseline" }}>
            <dl>
                ...
                <dt>Food</dt>
                <dd>
                    <ChangeValue values={planet.history.food} />{" "}
                    {planet.resources.food.toFixed(0)} T.
                </dd>
                <dt>Minerals</dt>
            ...
            <dl>
                ...
                <dt>Growth</dt>
                <dd>
                    <ChangeValue values={planet.history.growth} />{" "}
                    {Math.floor(planet.growth)} %
                </dd>
                <dt>Morale</dt>
...
const Authed = () => {
    return (
        <PlanetAuth view={(planet: IPlanet) => <Overview planet={planet} />} />
    )
}
