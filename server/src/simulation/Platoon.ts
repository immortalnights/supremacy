...
export default class Platoon implements IPlatoon {
    ...
    get strength(): number {
        ...
        const equipment =
            core *
            (EquipmentData[this.suit as keyof typeof EquipmentData].power +
                EquipmentData[this.weapon as keyof typeof EquipmentData].power)
        // aggression, core multiplied by aggression "step"
        const aggr = core * (aggressionpc / 0.25 - 1)
