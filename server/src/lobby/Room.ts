...
class Room implements IRoom {
    ...
    isEmpty(): boolean {
        return (
            ...
            this.players.every((player) => player instanceof AIPlayer)
        )
    }
    ...
    isReady(): boolean {
        return (
            this.players.length === MINIMUM_REQUIRED_PLAYERS &&
    ...
    handleReadyStateChanged(): void {
        ...
        if (this.isReady()) {
            console.log(
                `All players are ready in room ${this.id}, begin countdown`
            )
            ...
            const doCountdown = () => {
                ...
                if (false === this.isReady()) {
                    ...
                    this.events.emit("create-game", { ...this.options }, [
                        ...this.players,
                    ])
                }
